...
import { searchCV, getCVDataHandler,getAreaOcupacionDataHandler } from "../../controllers/admin/search_controller.js"; // Mantener esta importación
...
router.post('/buscar-cv', ensureAuth, ensureAdmin, searchCV); 
